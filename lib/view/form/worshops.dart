    ...
    return Scaffold(
      ...
      body: Consumer<WorkshopDataProvider>(
        builder: (BuildContext context, WorkshopDataProvider provider, Widget? child) {
          return provider.workshopModel.isEmpty
              ? const Center(child: Text("No Workshops Available", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)))
              : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => DetailPage(id: workshop.id,),));
                  },
                  child: Padding(
